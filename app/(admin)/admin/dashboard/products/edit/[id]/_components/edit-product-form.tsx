...
export default function EditProductForm({product}: EditProductFormProps) {
        ...
        (product.variants || [])
            ...
            .map(v => ({
                ...
                optionValues: v.optionValues
                    ? (() => { try { return JSON.parse(v.optionValues) } catch { return {} } })()
                    : {},
            }))
    )
        ...
        onSubmit: async ({value}) => {
            ...
            if (!result.success) {
                ...
                toast.error("Validation failed", {
                    description: fieldMessages.length > 0 ? fieldMessages.join("\n") : "Unknown validation error",
                    duration: 8000,
                })
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="flex h-14 items-center justify-between px-3 sm:px-4 lg:px-6">
                    ...
                    <div className="flex items-center gap-2">
                        <Button type="button" variant="outline" size="sm"
                                ...
                                disabled={mutation.isPending} className="hidden sm:inline-flex">
                            Cancel
                        </Button>
                        <Button type="submit" form="product-form" size="sm" disabled={mutation.isPending}>
            ...
            <form id="product-form" onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); form.handleSubmit() }}>
                    ...
                    <main className="flex-1 p-3 sm:p-4 lg:p-6 space-y-6 order-2 lg:order-1">
                                ...
                                return (
                                    <Field data-invalid={isInvalid}>
                                        <Input
                                            ...
                                            onChange={(e) => { field.handleChange(e.target.value); autoGenerateSlugFromName(e.target.value) }}
                                            aria-invalid={isInvalid} placeholder="Enter product name..." autoComplete="off"
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                                ...
                                                <Input id={field.name} name={field.name} value={field.state.value}
                                                       ...
                                                       aria-invalid={isInvalid} placeholder="auto-generated-slug"
                                                       autoComplete="off" className="flex-1 h-8 text-sm"/>
                                            </div>
                                            {field.state.value && (
                        ...
                        <div className="rounded-lg border bg-card shadow-sm">
                            <div className="p-4 border-b">
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">Define attributes like RAM/Storage, Color etc.</p>
                            </div>
                            <div className="p-4">
                                <ProductOptionBuilder value={options} onChange={setOptions}/>
                            </div>
                        </div>
                        ...
                        <div className="rounded-lg border bg-card shadow-sm">
                            <div className="p-4 border-b">
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">Set price, stock, and SKU for each variant.</p>
                            </div>
                            <div className="p-4">
                                <VariantTableBuilder value={variants} onChange={setVariants} options={options}/>
                            </div>
                        </div>
                        ...
                        {/* Key Features */}
                        <div className="rounded-lg border bg-card shadow-sm">
                            <div className="p-4 border-b"><h3 className="text-sm font-semibold">Key Features</h3></div>
                            <div className="p-4">
                                <form.Field name="keyFeatures">
                                    {(field) => {
                                        ...
                                        return (
                                            <Field>
                                                <KeyFeaturesBuilder value={featuresData}
                        ...
                        {/* Description */}
                        <div className="rounded-lg border bg-card shadow-sm">
                            <div className="p-4 border-b"><h3 className="text-sm font-semibold">Product Description</h3></div>
                            <div className="p-4">
                        ...
                        {/* Specifications */}
                        <div className="rounded-lg border bg-card shadow-sm">
                            <div className="p-4 border-b"><h3 className="text-sm font-semibold">Specifications</h3></div>
                            <div className="p-4">
                                <form.Field name="specifications">
                                    {(field) => {
                                        ...
                                        return (
                                            <Field>
                                                <SpecificationBuilder value={specData}
                                ...
                                {(field) => {
                                    ...
                                    return (
                                        <Field data-invalid={isInvalid}>
                                            ...
                                            <Select value={field.state.value ? field.state.value.toString() : undefined}
                                                    onValueChange={(value) => { const n = parseInt(value); field.handleChange(n); setSelectedCategory(n); form.setFieldValue("subCategoryId", undefined) }}>
                                ...
                                {(field) => {
                                    ...
                                    return (
                                        <Field data-invalid={isInvalid}>
                                            ...
                                            <Select value={field.state.value?.toString() || "none"}
                                                    onValueChange={(value) => { field.handleChange(value === "none" ? undefined : parseInt(value)) }}
                                ...
                                {(field) => (
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Label htmlFor={field.name} className="text-sm cursor-pointer">Featured</Label>
                                        </div>
